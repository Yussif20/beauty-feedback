...
const ThemeSwitcher = () => {
  ...
  return (
    <div className="flex items-center justify-around h-8 w-14 bg-pink-100 dark:bg-gray-800 rounded-3xl transition-colors duration-300">
      <button
        className={`${activeCircleStyles} ${
          theme === 'light'
            ? 'bg-white ring-pink-400/50'
      ...
      >
        <svg
          width="14"
          className="fill-pink-500 cursor-pointer"
          height="13"
          viewBox="0 0 14 13"
          fill="none"
